...
void detectAndDisplay(Mat picture)
{
	...
	face_cascade.detectMultiScale(picture_gray, faces, 1.1, 2, 0 | CV_HAAR_SCALE_IMAGE, Size(100, 100));
	...
	for (size_t i = 0; i < faces.size(); i++)
	{
		...
		ellipse(picture, center, Size(faces[i].width / 2, faces[i].height / 2), 0, 0, 360, Scalar(0, 225, 255),5, 2, 0);
	}
